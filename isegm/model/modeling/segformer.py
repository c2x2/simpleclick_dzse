...
class MixFFN(BaseModule):
    ...
    def __init__(self,
        ...
        self.dropout_layer = build_dropout(
            dropout_layer) if dropout_layer else jtorch.nn.Identity()
...
class MixVisionTransformer(BaseModule):
    ...
    def __init__(self,
        ...
        dpr = [
            x.item()
            for x in jtorch.linspace(0, drop_path_rate, sum(num_layers))
    ...
    def init_weights(self):
        if self.pretrained is None:
            ...
            state_dict['layers.0.0.projection.weight'] = jtorch.cat([ori_proj_weight, ori_proj_weight], dim=1)
